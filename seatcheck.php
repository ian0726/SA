...
<body class="sub_page">
  ...
  <div class="heading_container heading_center">
    <br><h2 class="seatitle" style='color:#C6B56F'>
      Seat
    </h2>
  </div>
  <center>
  <table style="font-family:NSimSun">
    <tr>
  ...
  if(isset($_SESSION['user_id'])){
  ?>
  <a href="queue.php" style='font-family:NSimSun'><button type="button" class="btn btn-chooseat">
      開始候位
    </button></a>
  <?php
  }
  ...
  <button type="button" class="btn btn-showaiting" data-bs-toggle="modal" data-bs-target="#exampleModal" style="font-family:NSimSun">
    查看候位狀態
  </button>

  <!-- Modal -->
  <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="font-family:NSimSun">
                ...
                if($check == 1){
                  ...
                  if($streak > $count){
                    ...
                    if ($count == 1){
                      ...
                      <div>
                      <a href='seatcheck.php' ><button type='button' class='btn-chooseat'><p>確認入座</p></button></a>
                      <input type='submit' class='btn btn-info btn-xs btn-edit' style='background-color:#C6B56F;border:none;color:white;font-weight:bold;' value='確認入座'>
                      </div>
                      </form>
                      <?php
                      break;
