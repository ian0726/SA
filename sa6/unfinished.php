          ...
          if($row['complete'] == 0){
            ...
            <td>
              <form action='orderfunc.php' method='post'>
                ...
                <input type='submit'  class='btn btn-success btn-xs btn-checkorder' value = '確認訂單'>
              </form>
              <form action='orderfunc.php' method='post'>
                <input type='hidden' name='id' value='".$row['order_id']."'>
                <input type='hidden' name='func' value='notify'>
                <input type='submit'  class='btn btn-warning btn-xs btn-notice' value = '通知領取'>
              </form>
            </td>
            <td>
              ...
              <form action='orderfunc.php' method='post'>
                ...
                <input type='submit'  class='btn btn-warning btn-xs btn-delete' value = '完成訂單'>
              </form>
            </td>
            </tr>";
          }
          elseif($row['complete'] == 1){
            ...
            <td>
              <form action='orderfunc.php' method='post'>
                <input type='hidden' name='id' value='".$row['order_id']."'>
                <input type='hidden' name='func' value='notify'>
                <input type='submit'  class='btn btn-success btn-xs btn-notice' value = '通知領取'>
              </form>
            </td>
            <td>
              <a href='' data-bs-toggle='modal' data-bs-target='#exampleModal".$row['order_id']."' style='text-decoration: none; color: white;'>
          ...
          elseif($row['complete'] == 2){
            ...
            <td>
              ...
              <form action='orderfunc.php' method='post'>
                <input type='hidden' name='id' value='".$row['order_id']."'>
                <input type='hidden' name='func' value='done'>
                <input type='submit'  class='btn btn-success btn-xs btn-delete' value = '完成訂單'>
              </form>
            </td>
            </tr>";
          }
          elseif($row['complete'] == 4){
            ...
            <td>
              ...
              <form action='orderfunc.php' method='post'>
                ...
                <input type='submit'  class='btn btn-danger btn-xs btn-delete' value = '逾期訂單'>
