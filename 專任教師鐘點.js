...
$("body").on("click", ".btn-edit", function(){
    ...
    $(this).parents("tr").find("td:eq(10)").prepend("<button class='btn btn-info btn-xs btn-update'>確認</button><button class='btn btn-warning btn-xs btn-cancel'>取消</button><button class='btn btn-danger btn-xs btn-delete'>刪除</button>")
    $(this).hide();
});
