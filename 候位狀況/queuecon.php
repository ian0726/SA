      ...
      while($row = mysqli_fetch_assoc($rs)){
       ...
       ";
        ...
        <td>
          ...
          <input type='hidden' name='id' value='".$row['queue_id']."'>
        ...
        <div class='modal-dialog modal-dialog-centered modal-dialog-scrollable'>
          <div class='modal-content' style='overflow:auto;'>
            <div class='modal-header'>
              <h5 class='modal-title' id='exampleModalLabel'>編輯｜訂單編號：".$row['queue_id']."</h5>
          ...
          ";
                ...
                if($rstemp = mysqli_query($con, $sqltemp)){
                  while($rowtemp = mysqli_fetch_assoc($rstemp)){
                    echo"
                    <input type='hidden' name = 'id[".$rowtemp['queue_id']."]' value = '".$rowtemp['queue_id']."'>
           
                    <div class='form-check'>更改人數&nbsp
                      <input type='number' class='formnumber' id='exampleFormControlInput' name = 'people[]' min='0' max='10' value = '".$rowtemp['people']."' required style='width: 90px;'>
                    </div><br>
                    ";
                  }
                }
