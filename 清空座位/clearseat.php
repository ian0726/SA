        ...
        <td>單人1桌<p class="seat_id1">
              <?php
                ...
                $row = mysqli_fetch_assoc($rs);
                  if ($row['occupied'] == 1) {
                    echo "<botton class='bi bi-check-square-fill'></botton>";
                    echo "<br>";
                    echo "<font size=\"3\" color=\"red\">&nbsp</font>";
                    echo   "<button type='button' class='btn btn-primary' data-bs-toggle='modal' data-bs-target='#exampleModal".$row['seat_id']."'>
                    清空
                  </button>
