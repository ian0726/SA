    ...
    <div class="container">
      ...
      <table class="table table-bordered data-table">
        ...
        <tbody>
          <?php
          $item_count = 0;
          $sql = "SELECT * FROM ordermain WHERE complete = 3";
        ...
        <td>
          <a href='' data-bs-toggle='modal' data-bs-target='#exampleModal" . $row['order_id'] . "' style='text-decoration: none; color: white;'>
            ...
            <button class='btn btn-danger btn-xs btn-edit'>回復評論</button>
          </a>";
                break;
              }
            }
        ...
        aria-hidden='true'>
          <div class='modal-dialog modal-dialog-centered modal-dialog-scrollable'>
            ...
            echo "
                  ...
                  <div class='modal-footer'>
                    <button type='button' class='btn btn-secondary' data-bs-dismiss='modal'>取消</button>
                    <input type='submit' class='btn btn-primary' value='送出回復'>
                  </div>
