                        ...
                        <div class='modal-content '>
                          ...
                          <div class='text-body'>
                            <form action='cartfunc.php' method = 'post'>
                              ...
                              <h5>&nbsp&nbsp數量</h5>
                              <input type='text' class='form-control' id='exampleFormControlInput' name = 'amount' value = '1' required>
                              <h5>&nbsp副餐(必選)</h5>
                             ...
                             <br>
                              ...
                              <div class='form-check-table overflow-auto'>
                                <select name='tablenum' size='26' style='display: inline-block;height: 100vh;' required>
                              ...
                              <br>
                              <h5 style='margin-top:-20px;'>&nbsp餐點備註</h5>
