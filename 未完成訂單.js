...
$("body").on("click", ".btn-finish", function(){
   // 點選完成後 狀態會跳至消費者已取餐且傳送至'已完成訂單'
    
});
$("body").on("click", ".btn-checkorder", function(){
    // 點選確認訂單後 狀態會跳至餐點準備中
    ...
    $(this).parents("tr").find("td:eq(8)").html(2);
 ...
 $("body").on("click", ".btn-notice", function(){
    ...
    $(this).parents("tr").find("td:eq(8)").html(3);
